...
public class RedisList<T> extends RedisCollection<T> implements List<T> {

    public RedisList(Jedis jedis, Class<T> clazz, String keyWithNameSpace) {
    ...
    public boolean add(T e) {
        ...
        if (index == 0) {
            ...
            jedis.linsert(keyWithNameSpace, LIST_POSITION.AFTER, previewValue, gson.toJson(e));
        }
        return true;
    }
