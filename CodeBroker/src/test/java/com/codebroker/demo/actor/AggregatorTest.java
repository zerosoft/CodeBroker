...
import static com.codebroker.demo.actor.AggregatorTest.IllustrateUsage.HotelCustomer;
import static com.codebroker.demo.actor.AggregatorTest.IllustrateUsage.Hotel1;
import static com.codebroker.demo.actor.AggregatorTest.IllustrateUsage.Hotel2;
...
//	public final LogCapturing logCapturing = new LogCapturing();
	...
	public void testUsageExample() {
		...
		quotes.forEach(quote -> System.out.println(quote.hotel+"="+quote.price));
