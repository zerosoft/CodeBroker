...
//	public final LogCapturing logCapturing = new LogCapturing();
	...
	public void askWithStatusExample() {
		...
		ActorRef<StandaloneAskSample.CookieFabric.Command> cookieFabric = testKit.spawn(StandaloneAskSample.CookieFabric.create());
	...
	public void askInActorWithStatusExample() {
		...
		ActorRef<Samples.Dave.Command> dave1 = testKit.spawn(Samples.Dave.create(hal));
		ActorRef<Samples.Dave.Command> dave2 = testKit.spawn(Samples.Dave.create(hal));
	}

	@Test
	public void testTail(){
//		testKit.spawn(TailChopping.create());
	}
}